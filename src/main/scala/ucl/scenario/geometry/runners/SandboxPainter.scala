package ucl.scenario.geometry.runners
...
import ucl.scenario.geometry.generators.{RandomCrazyPolygonGenerator, PolygonPropertyUtils}
import ucl.scenario.geometry.triangles.DualGraphUtils
import ucl.scenario.geometry.visibility.{JoeSimpsonVisibility, VisibilityChecker}
import ucl.scenario.geometry.{PointUtils, Point2D, Polygon}
import ucl.scenario.util.{GuardSolutionParser, GuardInputParser}
