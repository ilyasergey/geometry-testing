...
import ucl.scenario.geometry.visibility.VisibilityChecker.FailReason
import ucl.scenario.geometry.visibility.VisibilityChecker.FailReason.FailReason
import ucl.scenario.geometry.visibility.VisibilityChecker.FailReason.FailReason
import ucl.scenario.util.CheckInputParser
