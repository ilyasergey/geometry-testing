package ucl.scenario.geometry.visibility

import ucl.scenario.geometry.CommonUtils.GeometryException
import ucl.scenario.geometry.SegmentUtils._
import ucl.scenario.geometry.triangles.{Triangle, Triangulation}
import Triangulation._
import ucl.scenario.geometry.visibility.JoeSimpsonVisibility._
import ucl.scenario.geometry.{Point2D, Polygon, Segment}
